    ...
    <div className="min-h-[600px] max-h-auto">
      <section className="bg-white">
        <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 gap-y-12 lg:grid-cols-12">
          ...
          >
            <motion.h1
              className="max-w-2xl mb-4 text-4xl font-bold tracking-tight leading-none md:text-5xl xl:text-6xl"
            ...
            <div className="flex items-center">
              ...
              <div className="bg-[#A0C861] animate-pulse flex items-center justify-center -ml-4 text-white rounded-full w-10 h-10 text-sm">
          ...
          {/* Right Images */}
          <motion.div
            className="lg:col-span-5 flex justify-center flex-col md:flex-row lg:flex gap-y-10 lg:flex-col gap-3"
            initial={{ opacity: 0, scale: 0.8 }}
            animate={{ opacity: 1, scale: 1 }}
            transition={{ duration: 1.5 }}
          >
            <span className="w-full md:w-[90%] relative">
              <div className="absolute hidden animate-pulse lg:block -top-8 -right-12">
                <Image
                  alt="Hearts"
                  src={hearts}
